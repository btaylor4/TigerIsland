...
public class server {
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        PrintStream send_to_client = new PrintStream(socket.getOutputStream());

        //Testing Recieving Messages from Client
        ...
        //Testing Sent Messages from Client
        for(int i=0;i<2;i++)
        {
            message = test_statements.get(i);
            delay(10);
            send_to_client.println(message);
            message_incoming=input_from_client.nextLine();
            System.out.println("Server has recieved:"+message_incoming);
    ...
    public static void populate_vector()
    {
        ...
        test_statements.add("THANK YOU FOR PLAYING! GOODBYE");
    }
