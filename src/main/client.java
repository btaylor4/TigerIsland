...
public class client {
    ...
    public String IP_Address="10.136.63.249"; //IP Address of the machine (server) you want to connect to
    ...
    {
        int x=0,y=0,z=0,x_build=0,y_build=0,z_build=0,orientation=0;
        ...
        if(Objects.equals(message_pid, opponent_pid))
        {
            ...
            orientation=Integer.parseInt(split_by_space[12]);
    ...
    public void end_of_round()
    {
       System.out.println("Round has ended");
        //share relevant end of game details, such as score
    }
